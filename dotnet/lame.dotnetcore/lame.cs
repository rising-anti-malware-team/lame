...
namespace lame.dotnetcore
{
    ...
    {
        public delegate int InnerExtractEnterFileEvent(string fname, string fmt, uint depth, ulong flag, IntPtr fhandle,
            IntPtr userdata);

        public delegate void InnerExtractLeaveFileEvent(string fname, string fmt, uint depth, ulong flag,
            IntPtr fhandle, IntPtr userdata, uint l);
    ...
    internal class LameUtity
    {
        ...
        [DllImport("./lame.dll", EntryPoint = "lame_create", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern IntPtr lame_create_(IntPtr vdb);

        [DllImport("./lame.dll", EntryPoint = "lame_param_set", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_param_set_(IntPtr pEngine, string pFileName);

        [DllImport("./lame.dll", EntryPoint = "lame_init", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_init_(IntPtr pEngine);

        [DllImport("./lame.dll", EntryPoint = "lame_scan_file", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_scan_file_(IntPtr pEngine, string pFileName, ref ScanResult_ result);

        [DllImport("./lame.dll", EntryPoint = "lame_scan_file_with_callback", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_scan_file_with_callback_(IntPtr pEngine, string pFileName,
            ref LameScanFeedBack cb, IntPtr user_data);

        [DllImport("./lame.dll", EntryPoint = "lame_scan_mem", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_scan_mem_(IntPtr pEngine, byte[] data, uint uSize, ref ScanResult_ result);

        [DllImport("./lame.dll", EntryPoint = "lame_scan_mem_with_callback", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_scan_mem_with_callback_(IntPtr pEngine, byte[] data, uint uSize,
            ref LameScanFeedBack cb, IntPtr user_data);

        [DllImport("./lame.dll", EntryPoint = "lame_destroy", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern void lame_destroy_(IntPtr pEngine);

        [DllImport("./lame.dll", EntryPoint = "lame_get_licence_info", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_get_licence_info_(ref LameLicenceInfo_ license);

        [DllImport("./lame.dll", EntryPoint = "lame_get_version", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_get_version_(ref LameVesionInfo_ ver);


        [DllImport("./lame.dll", EntryPoint = "lame_extract_file", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_extract_file_(IntPtr pEngine, string fname, string password,
            ref LameExtractFeedBack cb, IntPtr user_data);

        [DllImport("./lame.dll", EntryPoint = "lame_file_get_size", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_file_get_size_(IntPtr pEngine);

        [DllImport("./lame.dll", EntryPoint = "lame_file_seek", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_file_seek_(IntPtr pEngine, int offset, int method);

        [DllImport("./lame.dll", EntryPoint = "lame_file_tell", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
        public static extern int lame_file_tell_(IntPtr pEngine);

        [DllImport("./lame.dll", EntryPoint = "lame_file_read", CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Ansi)]
    ...
    public class LameFile
    {
        ...
        public FileAttritue FileAttritue { get; }

        public ImmediateFile File { get; }
    ...
    public class LameExtractor : LameBase
    {
        ...
        private int ExtractEnterFileHandle(string fname, string fmt, uint depth, ulong flag, IntPtr handle,
            IntPtr userdata)
        {
            try
            {
