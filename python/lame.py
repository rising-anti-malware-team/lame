...
def LameScannerAlarm(fname , result , userdata):
    ...
    _lame = cast(userdata, py_object).value
    return _lame.Alarm(fname , _result)
...
class LameWithFeedback(LameBase):
    ...
    def ScanFile(self,fname):
        ...
        self._lame_dll_handle.lame_scan_file_with_callback(self._lame_engine_handle , fname , byref(self._feedback) , self._this_obj_ref)
